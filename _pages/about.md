...
# 💬 Project Skills
I am adept at developing various deep learning codes using PyTorch. Specifically, I am proficient in various applications of Graph Neural Networks, including node-level, edge-level, graph-level, and spatio-temporal graph modeling. Additionally, I have successfully reproduced models like FourCastNet, GraphCast and MeshGraphNet.
